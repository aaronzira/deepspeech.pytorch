...
def get_model():
    global MODEL
    if MODEL is None:
        MODEL = kenlm.Model('/home/aaron/Desktop/DeepSpeech/Mozilla/data/lm/lm.binary')
    return MODEL
...
# Load known word set
with open('/home/aaron/Desktop/DeepSpeech/Mozilla/data/spell/words.txt') as f:
...
def correction(sentence):
    ...
    out = re.sub("i m\\b", "i'm", out).upper()
